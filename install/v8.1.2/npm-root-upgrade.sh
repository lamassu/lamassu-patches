...
if [[ "$UBUNTU_VERSION" == "20.04" ]]; then
  ...
  echo
  echo -e "\033[1mUpdating lamassu-server to Grand Gilgamesh v8.1.1...\033[0m"
  echo
...
#        curl -o $(npm root -g)/lamassu-server/bin/lamassu-eth-sweep-to-new-wallet https://raw.githubusercontent.com/lamassu/lamassu-server/release-8.0/bin/lamassu-eth-sweep-to-new-wallet >> ${LOG_FILE} 2>&1
  ...
  sourceHash=$'459384179a7b5f32a9e30385d1e41672b1eb197f77f106e6c1947b557cbcc4ec'
  curl -sSLo /tmp/lamassu-server.tar.gz https://github.com/lamassu/lamassu-server/releases/download/v8.1.1/lamassu-server-v8.1.1.tar.gz >> $LOG_FILE 2>&1
