...
echo "Downloading Bitcoin Cash Node v26.1.0..."
sourceHash=$'68cb24d57898d5b47a1162a9683d0b0e36c6701b5a16b93edc94bbd82113c04b'
curl -#Lo /tmp/bitcoincash.tar.gz https://github.com/bitcoin-cash-node/bitcoin-cash-node/releases/download/v26.1.0/bitcoin-cash-node-26.1.0-x86_64-linux-gnu.tar.gz >> ${LOG_FILE} 2>&1
...
cp /tmp/bitcoin-cash-node-26.1.0/bin/bitcoind /usr/local/bin/bitcoincashd >> ${LOG_FILE} 2>&1
cp /tmp/bitcoin-cash-node-26.1.0/bin/bitcoin-cli /usr/local/bin/bitcoincash-cli >> ${LOG_FILE} 2>&1
rm -r /tmp/bitcoin-cash-node-26.1.0 >> ${LOG_FILE} 2>&1
