...
echo "Downloading Geth v1.12.2..."
sourceHash=$'f7e11f679c3d6c04a586ca5ce91b1501f0e14a34e4505c052faa9df8ae7b96d2'
curl -#o /tmp/ethereum.tar.gz https://gethstore.blob.core.windows.net/builds/geth-linux-amd64-1.12.2-bed84606.tar.gz >> ${LOG_FILE} 2>&1
...
echo "Updating..."
cp /tmp/geth-linux-amd64-1.12.2-bed84606/geth /usr/local/bin/geth >> ${LOG_FILE} 2>&1
rm -r /tmp/geth-linux-amd64-1.12.2-bed84606/ >> ${LOG_FILE} 2>&1
